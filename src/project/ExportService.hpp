...
/// Validates project, stages the player + runtime project content into a
/// new/empty directory, and writes export.manifest.json. Never deletes or
/// clears a non-empty user folder.
